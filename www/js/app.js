...
var appData = window.localStorage.getItem( 'first-launch' );
if(!window.localStorage.getItem('su')){
    window.localStorage.setItem('su','https://www.crowdwaka.com/crowdwaka-312198974560.php');
}
var startPageUrl,startPageState;
if(!appData){
    startPageUrl = "/app/tryApp";
    startPageState = "app.tryApp";
}
else{
...
window.globalVariable = {
    ...
    startPage: {
        url: startPageUrl,//Url of start page.
        state: startPageState//State name of start page.
    },
    message: {
